...
void TestBase::createFramebuffers() {
...
void TestBase::createCommandPool() {
...
void TestBase::createCommandBuffer() {
...
void TestBase::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
